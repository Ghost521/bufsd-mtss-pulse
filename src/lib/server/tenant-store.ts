...
const defaultSchools: SchoolRecord[] = [
  {
    ...
    addressLine1: "175 Jefferson Ave",
    city: "Buffalo",
    state: "NY",
    postalCode: "14204",
    latitude: 42.8864,
  ...
  },
  {
    ...
    addressLine1: "1500 South Park Ave",
    city: "Buffalo",
    state: "NY",
    postalCode: "14220",
    latitude: 42.8316,
  ...
  {
    id: "sch-lake",
    districtId: "dist-lakeside",
    name: "Lakeview Middle School",
    addressLine1: "7000 Lakeshore Rd",
    city: "Hamburg",
    state: "NY",
    postalCode: "14075",
    latitude: 42.7391,
  ...
  {
    id: "sch-river",
    districtId: "dist-riverside",
    name: "Riverside Elementary",
    addressLine1: "995 Tonawanda St",
    city: "Buffalo",
    state: "NY",
    postalCode: "14207",
    latitude: 42.9564,
