    ...
    <main className="min-h-screen bg-[#f6f2e9] text-[#3f332d]">
      <header className="border-b border-[#ede4d5] bg-[#faf7f0]">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-5 py-4 md:px-8">
          <div className="flex items-center gap-2">
            ...
            <p className="text-xs font-semibold uppercase tracking-[0.11em] text-[#6f6358]">MTSS Genius</p>
          </div>
          <nav className="hidden items-center gap-8 text-xs font-semibold text-[#988b7e] md:flex">
            <a href="/" className="transition-colors hover:text-[#6b5b4e]">Home</a>
            <a href="#features" className="transition-colors hover:text-[#6b5b4e]">Features</a>
        ...
        <div className="grid items-center gap-8 lg:grid-cols-[1fr_1.35fr]">
          <div>
            ...
            <p className="mt-5 max-w-md text-sm leading-relaxed text-[#8a7c70]">
              Bring intervention data, progress tracking, and collaboration into one clear flow designed for schools and districts.
            </p>
      ...
      <section className="border-y border-[#ebe1d2] bg-[#f0e9dc] px-6 py-14 text-center">
        <p className="mx-auto max-w-3xl text-xl font-semibold italic text-[#8b7c70] md:text-2xl">
          "I knew they were struggling, but the data was scattered everywhere."
        </p>
        <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-[#9f9183]">
          We built Pulse to unify fragmented support data so teams can spend less time chasing systems and more time helping students.
        </p>
      ...
      <section id="features" className="mx-auto w-full max-w-6xl px-5 py-16 md:px-8">
        <div className="grid items-center gap-8 lg:grid-cols-[1fr_1fr]">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.1em] text-[#d19d8f]">Unified MTSS visibility</p>
            <h2 className="mt-3 text-3xl font-bold text-[#5b4a3d]">Gain a 360-degree view of every student.</h2>
            <p className="mt-4 max-w-lg text-sm leading-relaxed text-[#8f7f72]">
              Pull attendance, interventions, fidelity, and communication signals into one timeline your support team can act on quickly.
            </p>
            <ul className="mt-5 space-y-2.5 text-sm text-[#7f7064]">
              <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-[#f0937c]" /> Evidence-based student snapshots</li>
              <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-[#f0937c]" /> Tier-aware intervention progress</li>
              <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-[#f0937c]" /> Context switching across district and school</li>
            </ul>
          </div>
          <div className="flex justify-center">
            <div className="relative h-[280px] w-[230px] rotate-[4deg] rounded-xl bg-[#3f6659] p-5 shadow-[0_20px_35px_-18px_rgba(36,51,45,0.65)]">
              ...
              <p className="mt-12 text-xs uppercase tracking-[0.14em] text-[#95b2a7]">Student Profile</p>
              <p className="mt-2 text-3xl font-bold text-[#dcebe5]">Pulse</p>
              <p className="mt-8 text-xs leading-relaxed text-[#bdd1c9]">One profile with attendance, interventions, fidelity, and family communication in context.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-14 grid items-center gap-8 lg:grid-cols-[1fr_1fr]">
          <div className="order-2 flex justify-center lg:order-1">
            <div className="relative h-[280px] w-[230px] -rotate-[5deg] rounded-xl bg-[#1f6d6a] p-5 shadow-[0_20px_35px_-18px_rgba(19,58,56,0.65)]">
              ...
              <p className="mt-12 text-xs uppercase tracking-[0.14em] text-[#9ed2cf]">Team Alignment</p>
              <p className="mt-2 text-3xl font-bold text-[#d7f0ef]">Collaborate</p>
              <p className="mt-8 text-xs leading-relaxed text-[#bae2e0]">Keep principals, teachers, and specialists coordinated without duplicating notes and decisions.</p>
            </div>
          </div>
          <div className="order-1 lg:order-2">
            <p className="text-[11px] font-semibold uppercase tracking-[0.1em] text-[#d19d8f]">Collaboration built in</p>
            <h3 className="mt-3 text-3xl font-bold text-[#5b4a3d]">Seamless collaboration for whole-child support.</h3>
            <p className="mt-4 max-w-lg text-sm leading-relaxed text-[#8f7f72]">
              Move from insight to action with shared plans, role-based access, and an audit-friendly workflow for every intervention decision.
            </p>
            <div className="mt-5 rounded-xl border border-[#eadfce] bg-[#f9f4ea] p-4">
              <p className="text-xs text-[#968679]">Staff note</p>
              <p className="mt-1 text-sm text-[#6d5f53]">"Pulse gave us one source of truth for meetings and follow-up actions."</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="support" className="border-y border-[#ece2d4] bg-[#faf7f0] px-5 py-16 md:px-8">
        <div className="mx-auto w-full max-w-6xl">
          <p className="text-center text-[11px] font-semibold uppercase tracking-[0.11em] text-[#c4b2a5]">Platform capabilities</p>
          <h2 className="mt-2 text-center text-3xl font-bold text-[#56463a]">The Support You Need to Support Them</h2>
          <p className="mx-auto mt-3 max-w-2xl text-center text-sm leading-relaxed text-[#8f7f72]">
            Built for MTSS teams who need clarity, speed, and accountability.
          </p>

          <div className="mt-8 grid gap-4 md:grid-cols-3">
            <article className="rounded-2xl border border-[#efdccc] bg-[#fff8ee] p-5">
              <Activity className="text-[#f08b6f]" size={18} />
              <h3 className="mt-3 text-lg font-bold text-[#5a4a3f]">Real-time Progress</h3>
              <p className="mt-2 text-sm text-[#8e7d6f]">View current intervention momentum and respond before students fall behind.</p>
            </article>
            <article className="rounded-2xl border border-[#efe1cd] bg-[#fff9ef] p-5">
              <MessageSquare className="text-[#d8a24f]" size={18} />
              <h3 className="mt-3 text-lg font-bold text-[#5a4a3f]">Smart Suggestions</h3>
              <p className="mt-2 text-sm text-[#8e7d6f]">Use AI-assisted prompts to draft communication and next-step recommendations.</p>
            </article>
            <article className="rounded-2xl border border-[#e8e8d4] bg-[#fcfbf1] p-5">
              <Users className="text-[#8fad61]" size={18} />
              <h3 className="mt-3 text-lg font-bold text-[#5a4a3f]">Parent First</h3>
              <p className="mt-2 text-sm text-[#8e7d6f]">Keep families informed with consistent, contextual updates and transparent plans.</p>
            </article>
          </div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="px-5 py-14 md:px-8">
        <div className="mx-auto w-full max-w-6xl rounded-[22px] bg-[#76523f] px-6 py-9 text-center text-[#fff8f2] md:px-10">
          <p className="text-xs uppercase tracking-[0.11em] text-[#f3d8c8]">Start your next cycle</p>
          <h2 className="mt-2 text-3xl font-bold leading-tight md:text-4xl">Start a new chapter in student success today.</h2>
          <p className="mx-auto mt-3 max-w-2xl text-sm text-[#f0e1d6]">Join teams using structured data and coordinated workflows to move support plans forward faster.</p>
      ...
      <footer className="border-t border-[#ebe1d2] bg-[#faf7f0] px-5 py-10 text-[#7f7063] md:px-8">
        <div className="mx-auto grid w-full max-w-6xl gap-8 md:grid-cols-[1.5fr_1fr_1fr_1.2fr]">
          <div>
            <div className="flex items-center gap-2">
              <span className="h-2.5 w-2.5 rounded-full bg-[#ff6b5e]" />
              <p className="text-xs font-semibold uppercase tracking-[0.11em]">MTSS Genius</p>
            </div>
            <p className="mt-3 max-w-xs text-sm leading-relaxed text-[#9a8b7f]">A modern MTSS operations workspace for schools and districts.</p>
            <p className="mt-4 text-xs text-[#b4a79b]">{helperText}</p>
          </div>
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.1em] text-[#a19285]">Product</p>
            <ul className="mt-3 space-y-2 text-sm">
              <li><a href="#features" className="hover:text-[#66574b]">Features</a></li>
              <li><a href="#support" className="hover:text-[#66574b]">Support</a></li>
              <li><a href="/app" className="hover:text-[#66574b]">Workspace</a></li>
            </ul>
          </div>
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.1em] text-[#a19285]">Resources</p>
            <ul className="mt-3 space-y-2 text-sm">
              <li><a href="/query-health" className="hover:text-[#66574b]">Health</a></li>
              <li><a href="/roster-table" className="hover:text-[#66574b]">Roster Table</a></li>
              <li><a href="/app/reports" className="hover:text-[#66574b]">Reports</a></li>
            </ul>
          </div>
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.1em] text-[#a19285]">Ready to start?</p>
            <p className="mt-3 text-sm text-[#988a7f]">Sign up for updates</p>
